...
@section('content')
                        ...
                        <div class="nftmax-table mg-top-40">
                            <div class="nftmax-table__heading">
                                <h3 class="nftmax-table__title mb-0">Employees <span class="nftmax-table__badge">{{ count($employees) }}</span></h3>
                                <ul  class="nav nav-tabs  nftmax-dropdown__list" id="nav-tab" role="tablist">
                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link "   href="{{ route('employees.create') }}" role="button" aria-expanded="false"><button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius nftmax-item__btn" type="submit">New employee</button></a>
                                    ...
                                    <table id="nftmax-table__main" class="nftmax-table__main nftmax-table__main-v1">
                                        ...
                                        <thead class="nftmax-table__head">
                                            <tr>
                                                ...
                                                <th class="nftmax-table__column-1 nftmax-table__h1">Employee data</th>
                                                <th class="nftmax-table__column-1 nftmax-table__h1">Department</th>
                                            ...
                                            @foreach ($employees as $employee )
                                                <tr>
                                                    <td class="nftmax-table__column-1 nftmax-table__data-1">
                                                        <div class="nftmax-table__product">
                                                            ...
                                                            <div class="nftmax-table__product-content">
                                                                <h4 class="nftmax-table__product-title">{{ $employee->user->full_name }}</h4>
                                                                <p class="nftmax-table__product-desc">Created at <a href="#">{{ $employee->created_at->format('F j, Y') }}</a></p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="nftmax-table__column-1 nftmax-table__data-1">
                                                        <div class="nftmax-table__product">
                                                            <div class="nftmax-table__product-content">
                                                                <p class="nftmax-table__product-desc">Email <a href="#">{{ $employee->email }}</a></p>
                                                                <p class="nftmax-table__product-desc">Phone Number <a href="#">{{ $employee->phone_number }}</a></p>
                                                                <p class="nftmax-table__product-desc">Address <a href="#">{{ $employee->address }}</a></p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="nftmax-table__column-1 nftmax-table__data-1">
                                                        <div class="nftmax-table__product">
                                                            <div class="nftmax-table__product-content">
                                                                <h4 class="nftmax-table__product-title">{{ $employee->department->name }}</h4>
                                                                <p class="nftmax-table__product-desc">Position <a href="#">{{ $employee->position->name }}</a></p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    
                                                    <td class="nftmax-table__column-7 nftmax-table__data-7">
                                                        <div class="nftmax-table__status nftmax-sbcolor">{{ $employee->status == 1 ? 'Active' : 'Inactive' }}</div>
                                                    </td>

                                                    <td class="nftmax-table__column-7 nftmax-table__data-7">
                                                        <div class="nftmax-table__status d-flex align-items-center"><a href="{{ route('employees.edit',['employee' => $employee->id ]) }}"><svg xmlns="http://www.w3.org/2000/svg" width=21 height=24 viewBox="0 0 512 512"><path fill=#f539f8 d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160L0 416c0 53 43 96 96 96l256 0c53 0 96-43 96-96l0-96c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 96c0 17.7-14.3 32-32 32L96 448c-17.7 0-32-14.3-32-32l0-256c0-17.7 14.3-32 32-32l96 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L96 64z"/></svg></a></div>
                                                    </td>
