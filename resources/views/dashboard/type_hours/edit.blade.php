...
<div class="nftmax-inner__heading">
    <h2 class="nftmax-inner__page-title">Edit {{ $type_hour->name }}</h2>
</div>
<!-- End All Notification Heading -->

<div class="nftmax-personals">
    <h2 class="nftmax-personals__title">Type of hour Info</h2>
    <div class="row">
                ...
                <div class="nftmax-ptabs__inner">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="id1" role="tabpanel">
                            <form action="{{ route('type_hours.update',['typeHour' => $type_hour->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                        <div class="nftmax-ptabs__separate">
                                            <div class="nftmax-ptabs__form-main">
                                                ...
                                                <div class="nftmax__item-form--group">
                                                    <label class="nftmax__item-label">Type of hour</label>
                                                    <input class="nftmax__item-input" name="name" type="text" value="{{ old('name',$type_hour->name) }}" required="required">
                                                </div>
                                                ...
                                                <div class="nftmax__item-form--group">
                                                    ...
                                                    <select class="form-select input-select-custom" name="type" aria-label="Category select">
                                                        <option value="1" {{ $type_hour->type == 1 ? 'selected' : '' }}>Normal</option>
                                                        <option value="2" {{ $type_hour->type == 2 ? 'selected' : '' }}>Time Paid Off</option>
                                                      </select>
                                                </div>
                                                ...
                                                <div class="nftmax-ptabs__social">
                                                    ...
                                                    <div class="nftmax-ptabs__verified">
                                                        <div class="nftmax-ptabs__verified-content">
                                                            <h4 class="nftmax-ptabs__accounts-heading">Delete Type of hour </h4>
                                                            <p class="nftmax__item-fee-text">Delete this type of hour forever </p>
                                                        </div>
                                                       
                                                        
                                                        <a href="#" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $type_hour->id }}').submit();" class="nftmax__item-button--single nftmax__item-button--cancel align-self-end">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="nftmax__item-button--group nftmax__ptabs-bottom">
                                    ...
                                    <button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius " type="submit">Update type of hour</button>
                                </div>
                            </form>

                            <form id="delete-form-{{ $type_hour->id }}" action="{{ route('type_hours.destroy', ['typeHour' => $type_hour->id]) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
