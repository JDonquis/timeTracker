...
@section('content')
                        ...
                        <div class="nftmax-inner__heading">
                            <h2 class="nftmax-inner__page-title">Create new department</h2>
                        </div>
                                                ...
                                                <div class="col-xxl-12 col-lg-12 col-12 nftmax-pcolumn__two">
                                                    <div class="nftmax__item-form--main">
                                                        ...
                                                        <div class="nftmax__item-form--group">
                                                            ...
                                                            <input class="nftmax__item-input" name="name" type="text" placeholder="Human Resources" value="{{ old('name') }}" required="required">
                                                        </div>
