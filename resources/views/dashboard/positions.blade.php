...
@section('content')
                        ...
                        <div class="nftmax-table mg-top-40">
                            <div class="nftmax-table__heading">
                                <h3 class="nftmax-table__title mb-0">Positions <span class="nftmax-table__badge">{{ count($positions) }}</span></h3>
                                <ul  class="nav nav-tabs  nftmax-dropdown__list" id="nav-tab" role="tablist">
                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link "   href="{{ route('positions.create') }}" role="button" aria-expanded="false"><button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius nftmax-item__btn" type="submit">New position</button></a>
                                ...
                                <div class="tab-pane fade show active" id="table_1" role="tabpanel" aria-labelledby="table_1">
                                    ...
                                    <table id="nftmax-table__main" class="nftmax-table__main nftmax-table__main-v1">
                                        ...
                                        <thead class="nftmax-table__head">
                                            <tr>
                                                <th class="nftmax-table__column-1 nftmax-table__h1">Position data</th>
