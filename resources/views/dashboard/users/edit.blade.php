...
<div class="nftmax-inner__heading">
    <h2 class="nftmax-inner__page-title">Edit {{ $user->full_name }}</h2>
</div>
                ...
                <div class="nftmax-ptabs__inner">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="id1" role="tabpanel">
                                        ...
                                        <div class="nftmax-ptabs__separate">
                                            <div class="nftmax-ptabs__form-main">
                                                ...
                                                <div class="nftmax__item-form--group">
                                                    ...
                                                    <input class="nftmax__item-input" name="full_name" type="text" value="{{ old('full_name',$user->full_name) }}" required="required">
                                                </div>
                                                
                                                <div class="nftmax__item-form--group">
                                                    <label class="nftmax__item-label">DNI</label>
                                                    <input class="nftmax__item-input" name="DNI" type="text" value="{{ old('DNI',$user->DNI) }}" required="required">
                                                </div>
                                                ...
                                                <div class="nftmax-ptabs__social">
                                                    ...
                                                    <div class="nftmax-ptabs__verified">
                                                        ...
                                                        <a href="#" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $user->id }}').submit();" class="nftmax__item-button--single nftmax__item-button--cancel align-self-end">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="nftmax-ptabs__sidebar">
                                                    <div class="nftmax-ptabs__ssingle nftmax-ptabs__srofile">
                                                        <div class="nftmax-ptabs__sheading">
                                                            ...
                                                            <p class="nftmax-ptabs__stext">Created at: <b>{{ $user->created_at->format('F j, Y') }}.</b> Role: <b>{{ $user->getRoleNames()[0] }}</b></p>
                                                        </div>
                                                        <div class="nftmax-ptabs__sauthor">
                                                            <div class="nftmax-ptabs__sauthor-img nftmax-ptabs__pthumb">
                                                                <img style="width: 62px; height: 62px; border-radius:50%;" class="object-fit-cover" src="{{ asset('storage/users/'.$user->photo) }}" alt="#">
                                                            </div>
                                                        </div>
                                                    </div>	
                            ...
                            <form id="delete-form-{{ $user->id }}" action="{{ route('usuarios.destroy', ['usuario' => $user->id]) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
