@php
    $typeMap = [1 => 'Normal', 2 => 'Time Paid Off'];
@endphp
...
@section('content')
                        ...
                        <div class="nftmax-table mg-top-40">
                            <div class="nftmax-table__heading">
                                <h3 class="nftmax-table__title mb-0">Type of hours <span class="nftmax-table__badge">{{ count($type_hours) }}</span></h3>
                                <ul  class="nav nav-tabs  nftmax-dropdown__list" id="nav-tab" role="tablist">
                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link "   href="{{ route('type_hours.create') }}" role="button" aria-expanded="false"><button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius nftmax-item__btn" type="submit">New type of hour</button></a>
                                ...
                                <div class="tab-pane fade show active" id="table_1" role="tabpanel" aria-labelledby="table_1">
                                    ...
                                    <table id="nftmax-table__main" class="nftmax-table__main nftmax-table__main-v1">
                                        ...
                                        <thead class="nftmax-table__head">
                                            <tr>
                                                <th class="nftmax-table__column-1 nftmax-table__h1">Type of hour data</th>
                                                    ...
                                                    <td class="nftmax-table__column-1 nftmax-table__data-1">
                                                        <div class="nftmax-table__product">
                                                            ...
                                                            <div class="nftmax-table__product-content">
                                                                <h4 class="nftmax-table__product-title">{{ $type_hour->name }}</h4>
                                                                <p class="nftmax-table__product-desc">Category: <a href="#">{{ $typeMap[$type_hour->type] }}</a></p>
